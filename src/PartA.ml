...
let weqtotal2dirprodcomm =false
...
let weqtotal2dirprodassoc =false
...
let isweqrdistrtocoprod y =false
...
let weqtotal2overcoprod' f = false
...
let isweqhfibersgtof' f f' g g' hf x = false
  (* let is = hf.pr2 in *)
  (* let h = hf.pr1 in *)
...
let ishfsqweqhfibersgtof' f f' g g' h is = f
  (* { pr1 = h; pr2 = *)
  (*   (let a = weqtococonusf g in *)
...
let isweqhfibersg'tof f f' g g' hf x' = f
  (* let is = hf.pr2 in *)
  (* let h = hf.pr1 in *)
  (* let a' = weqtococonusf g' in *)
  (* let c' = make_weq (commsqZtohfp f f' g g' hf.pr1) is in *)
...
let ishfsqweqhfibersg'tof f f' g g' h is = f
  (* { pr1 = h; pr2 = *)
  (*   (let a' = weqtococonusf g' in *)
  (*    let c0' = commsqZtohfp f f' g g' h in *)
  (*    let d' = weqhfptohfpoverX' f f' in *)
...
let transposhfpsqstr f f' g g' hf = f
  (* let is = hf.pr2 in *)
  (* let h = hf.pr1 in *)
...
let weqtodirprodwithunit = false
  (* let f = fun x -> make_dirprod x Coq_tt in *)
  (* { pr1 = f; pr2 = *)
  (* (let g = fun xu -> xu.pr1 in *)
  (*  let egf = fun _ -> Coq_paths_refl in *)
...
let dirprod_with_contr_r iscontrX = false
...
let dirprod_with_contr_l iscontrX = iscontrX
...
let sec_total2_distributivity = false
...
let isweqrecompl_ne' x is neq_x y = x
